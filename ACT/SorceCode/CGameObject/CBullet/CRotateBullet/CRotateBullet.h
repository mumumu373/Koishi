...
{
public:
	//			どの陣営のバレットか	ポジション	X方向の速さ		Y方向の速さ	X方向の中心からの位置	Y方向の中心からの位置
	CRotateBullet(int Camp, VECTOR2_f Pos, double X_Speed, double Y_Speed, double X_Range, double Y_Range);
	~CRotateBullet();
